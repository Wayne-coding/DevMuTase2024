...
def get_arg_opt():
    ...
    ssd r"/data1/pzy/mindb/ssd/datamind/ssd.mindrecord0"
    deeplabv3 /data1/pzy/mindb/Pascal_VOC_deeplab/datamind/traindata0

    pathcore /data1/pzy/raw/patchcore
    SSDmobilenetv1 --dataset_path /data1/pzy/mindb/ssd/datamind/ssd.mindrecord0
    fasttext r"/data1/pzy/mindb/dbpedia"
    textcnn r"/data1/pzy/mindb/rt-polarity/rt-polaritydata"
    bert r"/data1/pzy/mindb/bertdata/squad"
    transformer r"/data1/pzy/mindb/transformerdata"
    maskrcnn r"/data1/pzy/mindb/maskrcnn"
    fasterrcnn r"/data1/pzy/mindb/fasterrcnn/MindRecord_COCO2017"
    retinaface r'/data1/pzy/raw/WIDER_Face/train/label.txt'
    pangu --dataset_path r'/data1/pzy/mindb/pangu_lambda'
    yolov3 r'/data1/pzy/raw/coco2014'
    yolov4 /data1/pzy/raw/coco2017
    yolov5 r"/data1/pzy/raw/coco2017"
    unet r"/data1/pzy/raw/ischanllge"
    deeplabv3 r'/data1/pzy/mindb/Pascal_VOC_deeplab/datamind/traindata0'
    unet3d "/data1/pzy/mindb/LUNA16"


    openpose no need path
    patchcore /data1/pzy/raw/MVTecAD/
    ssimae /data1/pzy/raw/MVTecAD/
    lstm /data1/pzy/raw/lstm/preprocess
    wide_and_deep /data1/pzy/raw/wide_and_deep/mindrecord
    deepspeech /data1/pzy/raw/deepspeech/LibriSpeech_dataset
    gpt3 /data1/myz/net-sv/network/nlp/GPT/mindb
    crnn /data1/pzy/mindb/IC03/processed
    pinns /data1/pzy/raw/pinns/Data/NLS.mat
    llama /data1/pzy/mindb/alpaca/minddb/alpaca-fastchat2048.mindrecord
    """
